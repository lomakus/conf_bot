    ...
    default_texts = [
        {
            'key': 'faq_earn',
            'text': (
                "💰 КАК ЗАРАБОТАТЬ ЖЕТОНЫ?\n\n"
                "Есть два типа заданий: через бота (отправляешь фото) и через служителя (проверка лично).\n\n"

                "📸 ЗАДАНИЯ ЧЕРЕЗ БОТА\n"
                "Нажми кнопку «📸 Отправить фото» и отправь снимок. Служители проверят и начислят баллы.\n\n"
                "Примеры заданий:\n"
                ...
                "Подойди к служителю — он проверит и начислит баллы.\n\n"
                "Примеры заданий:\n"
                ...
                "• Победа в турнирах (баллы можно получить и за участие)\n"
                "• Раскраски в чилл-зоне\n"
                "• Побить рекорды в зоне рекордов"
            ),
            'description': 'FAQ: Как заработать жетоны'
        },
        {
            'key': 'faq_spend',
            'text': (
                "🎁 НА ЧТО ТРАТИТЬ ЖЕТОНЫ?\n\n"
                "Жетоны — это твоя валюта на конференции! Меняй их на вкусняшки, развлечения и крутые призы.\n\n"
                ...
                "💡 КАК ПОЛУЧИТЬ ТОВАР?\n"
                "Подойди к служителю в зоне обмена, покажи свой баланс и выбери, на что хочешь потратить жетоны. Служитель спишет нужное количество и выдаст тебе товар или доступ к развлечению.\n\n"

                "🔥 СОВЕТ\n"
                "Не копи жетоны до последнего дня — трать с умом и наслаждайся конференцией на полную!\n"
                "Лучшие призы разбирают быстро 😉"
            ),
            'description': 'FAQ: На что тратить жетоны'
        },
        {
            'key': 'welcome_message',
            'text': (
                "👋 Привет! Я бот конференции Огонь!\n\n"
                "Помогу тебе заработать жетоны, отслеживать баланс и участвовать в активностях.\n\n"
        ...
        },
        {
            ...
            'text': (
                "🛒 МАГАЗИН\n\n"
                "Ты можешь обменять жетоны на следующие товары:\n\n"
                ...
                "💡 КАК ПОЛУЧИТЬ ТОВАР?\n"
                "Подойди к служителю, покажи свой баланс и выбери товар. Служитель спишет жетоны и выдаст тебе товар.\n\n"

                "🔥 СОВЕТ\n"
                "Не копи жетоны до последнего дня — трать с умом и наслаждайся конференцией!"
            ),
